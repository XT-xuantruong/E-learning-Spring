...
const fetchTeachers = async () => {
  try {
    ...
    teachers.value = response.data.data.filter((ele) => ele.role === "TEACHER") || [];
  ...
  <DefaultLayout>
    <div class="min-h-screen bg-gray-50 p-6">
      ...
      <div v-if="showModal"
        ...
        <div class="bg-white rounded-xl shadow-xl w-full max-w-2xl mx-4 transform transition-all" @click.stop>
            ...
            <form @submit.prevent="updateTeacher()">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                  ...
                  <div class="flex items-center space-x-4">
                    <img :src="previewUrl" alt="Preview" class="h-12 w-12 rounded-full object-cover" />
